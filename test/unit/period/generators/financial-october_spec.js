...
describe('Financial October period', () => {
    ...
    describe('generateFinancialOctoberPeriodsUpToYear()', () => {
        it('should not allow years before the year zero', () => {
            expect(() => generateFinancialOctoberPeriodsUpToYear(-10)).to.throw();
        });

        it('should throw an error when passing a Date object', () => {
            expect(() => generateFinancialOctoberPeriodsUpToYear(new Date())).to.throw();
        });
        ...
        it('should throw an error when the numberOfYears is not a positive integer', () => {
            expect(() => generateFinancialOctoberPeriodsUpToYear(2017, 'a')).to.throw();
            expect(() => generateFinancialOctoberPeriodsUpToYear(2017, 1.2)).to.throw();
            expect(() => generateFinancialOctoberPeriodsUpToYear(2017, true)).to.throw();
            expect(() => generateFinancialOctoberPeriodsUpToYear(2017, -1)).to.throw();
            expect(() => generateFinancialOctoberPeriodsUpToYear(2017, 0)).to.throw();
            expect(() => generateFinancialOctoberPeriodsUpToYear(2017, Infinity)).to.throw();
        });
