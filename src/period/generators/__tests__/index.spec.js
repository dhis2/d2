    ...
    describe('createPeriodGeneratorsForLocale()', () => {
        describe('daily', () => {
            ...
            it('should have the daily period generator', () => {
                expect(
                    typeof createPeriodGeneratorsForLocale('nl')
            ...
            it('should call the the daily generator with the correct locale', () => {
                ...
                expect(daily.generateDailyPeriodsForYear).toBeCalledWith(
                    2017,
                    'nl'
                )
            })
            ...
            it('should return the same result as when calling the generator directly', () => {
                ...
                expect(generators.generateDailyPeriodsForYear(2017)).toEqual(
                    daily.generateDailyPeriodsForYear(2017, 'nl')
                )
            })
        })
        ...
        describe('weekly', () => {
            ...
            it('should call the weekly generator with the correct locale', () => {
                ...
                expect(weekly.generateWeeklyPeriodsForYear).toBeCalledWith(
                    2017,
                    'nl'
                )
            })
            ...
            it('should return the same result as when calling the generator directly', () => {
                ...
                expect(generators.generateWeeklyPeriodsForYear(2017)).toEqual(
                    weekly.generateWeeklyPeriodsForYear(2017, 'nl')
                )
            })
        })
        ...
        describe('monthly', () => {
            ...
            it('should call the weekly generator with the correct locale', () => {
                ...
                expect(monthly.generateMonthlyPeriodsForYear).toBeCalledWith(
                    2017,
                    'nl'
                )
            })
            ...
            it('should return the same result as when calling the generator directly', () => {
                ...
                expect(generators.generateMonthlyPeriodsForYear(2017)).toEqual(
                    monthly.generateMonthlyPeriodsForYear(2017, 'nl')
                )
            })
        })
        ...
        describe('six-monthly', () => {
            ...
            it('should return the same result as when calling the generator directly', () => {
                ...
                expect(
                    ...
                    sixmonthly.generateSixMonthlyPeriodsForYear(2017, 'nl')
                )
            })
        })
        ...
        describe('yearly', () => {
            ...
            it('should call the weekly generator with the correct locale', () => {
                ...
                expect(yearly.generateYearlyPeriodsUpToYear).toBeCalledWith(
                    2017,
                    undefined,
                    'nl'
                )
            ...
            it('should return the same result as when calling the generator directly', () => {
                ...
                expect(
                    generators.generateYearlyPeriodsUpToYear(2017, 10)
        ...
        describe('financial-october', () => {
            ...
            it('should call the weekly generator with the correct locale', () => {
                ...
                expect(
                    financialoctober.generateFinancialOctoberPeriodsUpToYear
                ).toBeCalledWith(2017, undefined, 'nl')
            })
            ...
            it('should return the same result as when calling the generator directly', () => {
                ...
                expect(
                    generators.generateFinancialOctoberPeriodsUpToYear(2017, 5)
                ).toEqual(
                    financialoctober.generateFinancialOctoberPeriodsUpToYear(
                        2017,
                        5,
        ...
        describe('financial-july', () => {
            ...
            it('should return the same result as when calling the generator directly', () => {
                ...
                expect(
                    generators.generateFinancialJulyPeriodsUpToYear(2017, 5)
                ).toEqual(
                    financialjuly.generateFinancialJulyPeriodsUpToYear(
                        2017,
                        5,
        ...
        describe('financial-april', () => {
            ...
            it('should return the same result as when calling the generator directly', () => {
                ...
                expect(
                    generators.generateFinancialAprilPeriodsUpToYear(2017, 5)
                ).toEqual(
                    financialapril.generateFinancialAprilPeriodsUpToYear(
                        2017,
                        5,
