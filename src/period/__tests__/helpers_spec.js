...
describe('Period helpers', () => {
    ...
    describe('getFirstDateOfQuarter()', () => {
        it('returns the correct start date for each quarter', () => {
            expect(getFirstDateOfQuarter(2017, 1).toDateString()).toBe(
                new Date(2017, 0, 1).toDateString()
            )
            expect(getFirstDateOfQuarter(2017, 2).toDateString()).toBe(
                new Date(2017, 3, 1).toDateString()
            )
            expect(getFirstDateOfQuarter(2017, 3).toDateString()).toBe(
                new Date(2017, 6, 1).toDateString()
            )
            expect(getFirstDateOfQuarter(2017, 4).toDateString()).toBe(
                new Date(2017, 9, 1).toDateString()
            )
        })
    })
    describe('getLastDateOfQuarter()', () => {
        it('returns the correct end date for each quarter', () => {
            ...
            expect(getLastDateOfQuarter(2017, 1).toDateString()).toBe(
                lastOfMarch.toDateString()
            )
            expect(getLastDateOfQuarter(2017, 2).toDateString()).toBe(
                lastOfJune.toDateString()
            )
            expect(getLastDateOfQuarter(2017, 3).toDateString()).toBe(
                lastOfSept.toDateString()
            )
            expect(getLastDateOfQuarter(2017, 4).toDateString()).toBe(
                lastOfDec.toDateString()
            )
        })
    })
})
