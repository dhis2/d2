...
describe('Api', () => {
    ...
    describe('request()', () => {
        ...
        it('401 should call unauthorizedCb if set', () => {
            ...
            api.get('dataElements/401').catch(() => {
        ...
        it('should properly encode URIs', () => {
            ...
            return api
                .get('some/endpoint?a=b&c=d|e[with:filter]', {
        ...
        it('should not break URIs when encoding', () => {
            ...
            return api.get('test?a=b=c&df,gh').then(() => {
                expect(fetchMock).toHaveBeenCalledWith(
        ...
        it('should encode data as JSON', () => {
            ...
            return api.post('jsonData', data).then(() => {
